...
-- Adding AWR SQL text collection for Pionner
 DBMS_OUTPUT.PUT_LINE('SELECT sql_text');
 DBMS_OUTPUT.PUT_LINE('into sql_txt');
 DBMS_OUTPUT.PUT_LINE('from dba_hist_sqltext');
 DBMS_OUTPUT.PUT_LINE('where sql_id='||'''&&sql_id.'''||';');
